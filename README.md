...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/keda-scaling/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/keda-scaling/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-keda-scaling.git
cd tp-keda-scaling
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/keda-scaling/) |
